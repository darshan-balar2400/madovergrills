        ...
        <section>
            ...
            <div class="hero-section menu-hero-section">
                <div class="hero-content container justify-content-center d-flex">
                    <h1 class="title  text-center">Branches</h1>
                </div>
            </div>
            <!-- menu Section -->
            <div class="branch-section container">
                <?php

                    while($row = mysqli_fetch_array($result)){
                        echo " <div class='branch'>
                        <div class='row'>
                            <div class='col-sm-6 map col_'>
                                <iframe src='$row[6]' loading='lazy' referrerpolicy=' no-referrer-when-downgrade'></iframe>
                            </div>
                            <div class='col-sm-6 content col_'>
                            <h1 class='title'>$row[5]</h1>
                            <h5 class='small-title'> $row[3]</h5>
                            <a href='tel:$row[4]'><button class='button mt-5'>+91 $row[4]</button></a>
                            </div>
                        </div>
                    </div>";
                    }
